...
private final Queue<Point> beepersL=new LinkedList<>();
private final Queue<Point> crucesL=new LinkedList<>();
...
public synchronized int getRobots(){
    return this.robots;
}
}
